  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        learning: {
          alphabet: "var(--color-alphabet)",
          numbers: "var(--color-numbers)",
          shapes: "var(--color-shapes)",
          colors: "var(--color-colors)",
          animals: "var(--color-animals)",
        ...
        language: {
          ...
          malayalam: "var(--color-malayalam)",
          english: "var(--color-english)",
          spanish: "var(--color-spanish)",
